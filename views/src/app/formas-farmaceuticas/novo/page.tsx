...
export default function NovaFormaFarmaceuticaPage() {
    ...
    return (
        <WithPermission requiredPermission="formas_farmaceuticas.criar">
            <Header />
            <Menu />
                ...
                <div className={styles.container}>
                    <div className={styles.contentWrapper}>
                        <div className={styles.header}>
                            ...
                            <h1>Nova Forma Farmacêutica</h1>
                            <p>Preencha os dados abaixo para criar uma nova forma farmacêutica</p>
                        </div>
                        ...
                        <form ref={formRef} className={formStyles.form} onSubmit={handleSubmit}>
                                        ...
                                        <div className={formStyles.inputGroup}>
                                            <label htmlFor="descricao">
                                                ...
                                                <input 
                                                    ...
                                                    name="descricao"
                                                    required 
                                                    placeholder="Ex: Comprimido, Cápsula, Xarope, etc." 
                            ...
                            <div className={formStyles.formFooter}>
                                <button
                                    ...
                                    disabled={saving}
                                >
                                    {saving ? 'Criando...' : 'Criar Forma Farmacêutica'}
                                </button>
                            </div>
                        </form>
                    </div>
