...
export default function EditarFormaFarmaceuticaPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (error.response?.status === 401) {
                ...
                toast.error(error.response?.data?.error || 'Erro ao atualizar forma farmacêutica');
            }
        } finally {
            setSaving(false);
        }
    ...
    if (!mounted || loading) {
        return (
            <WithPermission requiredPermission="formas_farmaceuticas.editar">
                <Header />
                <Menu />
                ...
                <div className={styles.container}>
                    <div className={styles.contentWrapper}>
                        <div className={styles.header}>
                            ...
                            <p>Atualize os dados do forma farmacêutica</p>
                        </div>
                        ...
                        <form ref={formRef} className={formStyles.form} onSubmit={handleSubmit}>
                            <div className={formStyles.card}>
                                <div className={formStyles.cardHeader}>
                                    ...
                                    <h3>Informações do Forma Farmacêutica</h3>
                                </div>
