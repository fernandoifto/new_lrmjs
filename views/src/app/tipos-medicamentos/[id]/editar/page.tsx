...
export default function EditarTipoMedicamentoPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error('Erro ao atualizar tipo de medicamento:', error);
            if (error.response?.status === 401) {
                toast.error('Sessão expirada. Faça login novamente.');
                router.push('/login');
            } else {
                toast.error(error.response?.data?.error || 'Erro ao atualizar tipo de medicamento');
            }
        } finally {
            setSaving(false);
        }
                ...
                <div className={styles.container}>
                    <div className={styles.contentWrapper}>
                        <div className={styles.header}>
                            ...
                            <p>Atualize os dados do tipo de medicamento</p>
                        </div>
