        ...
        <>
            ...
            <footer className={styles.footer} id="contato">
                <div className="container-fluid">
                    <div className='row'>
                        <div className='col-sm-12 col-md-4 col-lg-4 align-items-center justify-content-center' >
                        ...
                        <div className='col-sm-12 col-md-6 col-lg-4' >
                            <h3 className="h5 mb-3 mt-4 text-center">Parceiros</h3>
                        ...
                        <div className='col-sm-12 col-md-2 col-lg-4' >
                            <h3 className="h5 mb-3 mt-4 text-center">Siga-nos</h3>
