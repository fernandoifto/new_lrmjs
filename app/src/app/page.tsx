...
import Image from 'next/image'; // Importando o componente Image do Next.js para otimização de imagens
...
export default function Home() {
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={`${styles.section} py-5`} style={{ backgroundColor: '#f8f9fa' }} id="como-descartar">
        <div className="container" >
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4 mb-4 mb-md-0">
              <h3 className="h5 mb-3">Siga-nos</h3>
              ...
              <address className="mt-3">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <span>contato@remed.org.br</span>
                </div>
              </address>
            </div>
            
            <div className="col-md-8 mb-4 mb-md-0">
              <h3 className="h5 mb-3">Parceiros</h3>
              <div className={styles.partnersGrid}>
                <div className={styles.partnerLogo}>
                  <div className={styles.partnerPlaceholder}>Logo 1</div>
                </div>
                <div className={styles.partnerLogo}>
                  <div className={styles.partnerPlaceholder}>Logo 2</div>
                </div>
                <div className={styles.partnerLogo}>
                  <div className={styles.partnerPlaceholder}>Logo 3</div>
                </div>
                <div className={styles.partnerLogo}>
                  <div className={styles.partnerPlaceholder}>Logo 4</div>
                </div>
              </div>
            </div>
          </div>
